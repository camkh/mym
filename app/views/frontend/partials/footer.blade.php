                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div style="height:0px;overflow: hidden">
						    <a href="http://whos.amung.us/stats/w90etiqe6ijo/" target="_blank">
						        <img src="http://whos.amung.us/cwidget/w90etiqe6ijo/ffc20e000000.png" title="all" height="29" border="0" width="81"/>
						    </a>
						</div>
                    </div>
...
<script type='text/javascript'>
	function renderAds() {
		...
		postscribe(div1, '<style>.respondsive-ad-top { width: 300px; height: 250px;}@media(min-width: 1440px) '+
				...
				'{.respondsive-ad-top {width: 300px; height: 250px; } }@media(max-width: 468px)'+
