...
Route::any('/search/label', 'FePageController@searchByLabel');
Route::any('/search/label/{label_name}', 'FePageController@searchByLabel');
Route::any('/searchallajax', 'FePageController@searchByLabelAajex');
Route::any('/singlepagejson', 'FePageController@getSinglePageJson');
Route::any('/ajax', 'FePageController@getAjax');
Route::any('/rss', 'FePageController@getRss');
Route::any('/p/{page}', 'FePageController@page');
