...
$(document).ready(function() {
  ...
  $(".lightOn").click(function() {
    ...
    if($("#lights-overlay").is(":hidden")) {
      $(this).html(vdo_lang.lights_off).removeClass("lightOff")
    }else {
      $(this).html(vdo_lang.lights_on).addClass("lightOff")
    }
    return false
  })
});
...
$(document).ready(function() {
	$("#register-form").validate({
		...
		messages: {
			name: {
				required: vdo_lang.validate_name,
				minlength: vdo_lang.validate_name_long
			},
			username: {
				required: vdo_lang.validate_username,
				minlength: vdo_lang.validate_username_long
			},
			pass: {
				required: vdo_lang.validate_pass, 
				minlength: vdo_lang.validate_pass_long
			},
			confirm_pass: {
				required: vdo_lang.validate_pass,
				minlength: vdo_lang.validate_pass_long,
				equalTo: vdo_lang.validate_confirm_pass_long
			},
			imagetext: {
				required: vdo_lang.validate_captcha
			},
			email: vdo_lang.validate_email,
			agree: vdo_lang.validate_agree
		},
		errorClass: "error"
	});
});
...
$(document).ready(function() {
    $("#vdo_sources").change(function () {
        var str = $("select option:selected").attr('value');
        $("#vdo_sources_ex").text(str);
    })
    .change();
